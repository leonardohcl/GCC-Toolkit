...
for idx in range(img_count):
    print("processing ({}/{}): {}".format(idx+1, img_count,data.getFilename(idx)))
...
# 8. Write arff file
fh.createArffFile("test",output,names,[0,1])

time_elapsed = time.time() - start
print('Extraction complete in {:.0f}m {:.0f}s'.format(time_elapsed // 60, time_elapsed % 60))